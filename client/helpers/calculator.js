...
const createPaper = async (ids, fetch, options) => {
  let request = await fetch("/api/calculators/create-paper", options)
    .then((res) => res.json())
    .then((data) => data);
  return request;
};

const deletePaper = async (fetch, options) => {
  let request = await fetch("/api/calculators/delete-paper", options)
    .then((res) => res.json())
    .then((data) => data);
  return request;
};

const getPapers = async (fetch) => {
  let request = await fetch("/api/calculators/papers")
    .then((res) => res.json())
    .then((data) => data);
  return request;
};

const countPapers = async (fetch) => {
  let request = await fetch("/api/calculators/pricingcount")
    .then((res) => res.json())
    .then((data) => data);
  return request;
...
const getPaper = async (id, fetch) => {
  let request = await fetch("/api/calculators/paper?id=" + id)
    .then((res) => res.json())
    .then((data) => data);
  return request;
};

const updatePaper = async (fetch, options) => {
  let request = await fetch("/api/calculators/update-price", options)
    .then((res) => res.json())
    .then((data) => data);
  return request;
